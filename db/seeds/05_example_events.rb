@events = Event.create!([
  ...
  { title: 'Boxveranstaltung', date: Date.parse("2014-01-25"), club_id: 2, approved: true, contact_mail: @clubs[1].contact_mail, :boxers => @meldeliste },
  { title: 'Boxveranstaltung', date: Date.parse("2014-02-02"), club_id: 3, approved: true, contact_mail: @clubs[2].contact_mail},#, :boxers => @boxers_1 }, 
  { title: 'BL in Herzberg', date: Date.parse("2014-02-14"), club_id: 4, approved: true, contact_mail: @clubs[3].contact_mail},#, :boxers => @boxers_2 }, 
  { title: 'BL in Berlin', date: Date.parse("2014-02-22"), club_id: 4, approved: true, contact_mail: @clubs[3].contact_mail},#, :boxers => @boxers_3 }, 
